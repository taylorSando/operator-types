 ...
 */
export type Action = "tabs.list" | "tabs.create" | "tabs.close" | "window.bounds" | "screenshot" | "dom.querySelector" | "evaluate" | "page.content" | "page.info" | "interact.click" | "interact.type" | "interact.scroll" | "interact.findInteractive" | "research.dispatch" | "research.snapshot" | "social.dispatch" | "network.capture" | "network.snapshot" | "console.capture" | "performance.metrics" | "screenshot.fullpage" | "screenshot.emulated" | "cookies.getAll" | "picker.activate" | "operatorTrace.start" | "operatorTrace.stop" | "operatorTrace.status" | "runtime.reload" | "runtime.version";
...
export type ExtensionMessage = HelloMessage | HeartbeatMessage | ResultMessage | CancelAckMessage | ResearchCompleteMessage | ResearchProgressMessage;
...
export type SocialActionType = "social.collectFollowers" | "social.collectFollowing" | "social.collectEngagers" | "social.collectPostContext" | "social.profileSnapshot";
...
export type Command = TabsListCommand | TabsCreateCommand | TabsCloseCommand | WindowBoundsCommand | ScreenshotCommand | QuerySelectorCommand | EvaluateCommand | ClickCommand | TypeCommand | ScrollCommand | FindInteractiveCommand | PageContentCommand | PageInfoCommand | ResearchDispatchCommand | ResearchSnapshotCommand | SocialDispatchCommand | NetworkCaptureCommand | NetworkSnapshotCommand | ConsoleCaptureCommand | PerformanceMetricsCommand | FullPageScreenshotCommand | ScreenshotEmulatedCommand | CookiesGetAllCommand | PickerActivateCommand | OperatorTraceStartCommand | OperatorTraceStopCommand | OperatorTraceStatusCommand;
...
//# sourceMappingURL=browser-bridge-ws.d.ts.map